...
The technologies implemented in this project are React, React-Router 4.0, Webpack, VanillaJS, JSX, CSS, and Leaflet. I chose to use the `create-react-app` boilerplate to minimize initial setup. Testing is done with Chai and Enzyme.
